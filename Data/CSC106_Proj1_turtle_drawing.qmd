...
2.	Demonstrate that you can use the programming concepts that we’ve covered so far: function calls, function definitions, variables and assignment
...
1.	Are your files properly commented? This should include the following:
    a.	Header comment, with name, date, assignment and a brief description of the program.
...
3.	Have you cleaned up any code snippets you no longer need?
    a.	The final version of the program should not contain any lines of actual code that are commented out to keep them from running, these lines should be removed before submitting.
...
*	Organization: use whitespace to indicate the logical structure of the code.
	...
	+	there are no lines of code that do not contribute to the program


	# Demonstration Instructions

* confirm availability for  a 10 minute time slot
* submit all your code to gradescope
* bring printed versions of your code and generated images
* be prepared to answer the following questoins:
