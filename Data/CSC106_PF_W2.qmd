...
**Due Thurs. Sept. 24th at the end of class.**
...
|----|------------------------------------------------ |------|---------|--------------|-----------------------------|
| A1  | Written prompt                                          |   2  |     |       |          |
| A2  | Functioncs for Reeborg (stars, carrots)       |   3  |   Th 9/17  |       |          |
| A3  | Prog. with Turtle (flowers)                             |  5   |  F 9/18   |       |          |
| A4  | Functions I/O (even, math quiz, return)         |  7   |  M 9/21   |       |          |
| A5  | Prog. with Turtle (house)                      |   11  |  W 9/23    |       |          |
| A6  | Prog. Python (ascii art)                       |   13  |  Th 9/24   |       |          |
| A7  | Written study questions                        |  15   |  oyo   |       |          |
| A8  | Prog. Python (temp, bookstore)                 |  18   |  oyo   |       |          |
| A9  | Prog. Python (birthday)                    |  21   |   oyo  |       |          |
| A10 | Prog. Python (cricut)                        |  23   |   oyo  |       |          |
| B1  | Share-out report                               |  25   |   oyo  |       |          |
...
4. Did the autograder(s) produce error messages? How might you revise your algorithm and/or program?
